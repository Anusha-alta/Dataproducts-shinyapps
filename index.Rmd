...
library(datasets)
plot(airquality$Ozone, airquality$Temp,main= paste("Impact of Ozone on Temps"), xlab = "Ozone", ylab = "Temperature",  col = c("dark green", "red", "orange") )
    reg1 <- lm(Temp ~ aqData[, col], data = aqData)
